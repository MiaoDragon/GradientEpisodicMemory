...
$MY_PYTHON main.py $MNIST_PERM --model gem --lr 0.1 --n_memories 50 --memory_strength 0.5 --seed 10
$MY_PYTHON main.py $MNIST_PERM --model single_reservoir --lr 0.1 --n_memories 1000 --memory_strength 0.5 --seed 10
$MY_PYTHON main.py $MNIST_PERM --model gem --lr 0.1 --n_memories 50 --memory_strength 0.5 --seed 100
$MY_PYTHON main.py $MNIST_PERM --model single_reservoir --lr 0.1 --n_memories 1000 --memory_strength 0.5 --seed 100
$MY_PYTHON main.py $MNIST_PERM --model gem --lr 0.1 --n_memories 50 --memory_strength 0.5 --seed 77
$MY_PYTHON main.py $MNIST_PERM --model single_reservoir --lr 0.1 --n_memories 1000 --memory_strength 0.5 --seed 77
$MY_PYTHON main.py $MNIST_PERM --model gem --lr 0.1 --n_memories 50 --memory_strength 0.5 --seed 88
$MY_PYTHON main.py $MNIST_PERM --model single_reservoir --lr 0.1 --n_memories 1000 --memory_strength 0.5 --seed 88
#$MY_PYTHON main.py $MNIST_PERM --model minst_cont_model_prio --lr 0.1 --n_memories 50 --memory_strength 0.5
